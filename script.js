...
const add = document.getElementsByClassName('btn')
...
function showQuestion(question) {
    ...
    question.answers.forEach((answer) =>{
        ...
        button.addEventListener('click', selectAnswer, setnextQuestion)
...
const questions = [
    ...
    {
        question: "Who is PDP's presidential flaggbearer?",
        answers: [
            {text: 'Atiku Abubakar', correct: true},
